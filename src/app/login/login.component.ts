...
export class LoginComponent implements OnInit {
  ...
  constructor(private service: LoginService, private jwt: JWTTokenServiceService, private router: Router, private modalService: NgbModal, private noTokenService: IgnoredInteceptorService) {
  }
